 ...
 */
public class MicrosoftTranslatorR1Test {
    ...
    MicrosoftTranslatorR1 translator;
    ...
    public void testAzureTokenJustExpired() {
        ...
        translator = new MicrosoftTranslatorR1.Builder(TEST_CLIENT_ID, TEST_CLIENT_SECRET)
                .token(token)
    ...
    public void testGetCorrectToken() throws IOException {
        ...
        MicrosoftBorterToken expectedBorterToken = new MicrosoftBorterToken("Bearer " + TEST_ACCESS_TOKEN, TEST_CURRENT_TIME + TEST_EXPIRES_IN * 1000 - MicrosoftTranslatorR1.EXPIRATION_SAFETY_DURATION);
    ...
    public void testGetTokenInvalidClientId() throws IOException {
        ...
        TestSubscriber<MicrosoftBorterToken> testSubscriber = new TestSubscriber<>();
        translator = new MicrosoftTranslatorR1.Builder("wrong_client_id", TEST_CLIENT_SECRET)
                .azureTokenServiceURL(mockWebServer.url("/").toString())
                .build();
