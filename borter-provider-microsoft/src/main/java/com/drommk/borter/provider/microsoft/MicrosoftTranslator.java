...
public class MicrosoftTranslator implements Translator {
    ...
    private void initAzureTokenService() {
        ...
        azureTokenService = new Retrofit.Builder()
                .baseUrl(azureTokenServiceURL)
    ...
    private void initTranslatorService() {
        ...
        translatorService = new Retrofit.Builder()
                .baseUrl(translationServiceUrl)
                .addCallAdapterFactory(rxJavaCallAdapterFactory)
                .addConverterFactory(converterFactory)
                .client(okHttpClient)
                .build()
